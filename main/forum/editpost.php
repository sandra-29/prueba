...
if ($origin != 'learnpath') {
    ...
    if ($origin == 'group') {
        echo '<a href="../group/group_space.php?'.api_get_cidreq().'">'.
            Display::return_icon('back.png', get_lang('BackTo').' '.get_lang('Groups'), array(), ICON_SIZE_MEDIUM).'</a>';
    } else {
        echo '<a href="index.php?'.api_get_cidreq().'">'.
            Display::return_icon('back.png', get_lang('BackToForumOverview'), array(), ICON_SIZE_MEDIUM).'</a>';
    }
    echo '<a href="viewforum.php?forum='.intval($_GET['forum']).'&'.api_get_cidreq().'">'.
        Display::return_icon('forum.png', get_lang('BackToForum'), array(), ICON_SIZE_MEDIUM).'</a>';
    echo '</div>';
}
